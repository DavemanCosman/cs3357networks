...
def main():
    ...
    while True:
        ...
        if ack == 0 and seqCorrect == True:
            #update sequence if no corruption and seqCorrect is true
...
def Checkseq(UDP_Packet, seq):
    if UDP_Packet[1] == seq:
        ...
        print ('Sequence number misalignment: ', seq)
        return False;
